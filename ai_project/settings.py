...
SECRET_KEY = 'django-insecure-q(z!yn(pt-uf$1hpu+&!ygb)uvmwk2e5h#5v(2b1-%hv%=+cw4'
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'Django REST API for Market Research Analysis - Stock data, news aggregation, and sentiment analysis',
    'VERSION': '1.0.0',
